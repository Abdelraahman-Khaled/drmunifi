...
export async function generateMetadata({ params }) {
    ...
    const canonicalUrl = language === 'ar'
        ? `https://www.almunifi.com/operation-details/${blog.slug_ar}`
        : `https://www.almunifi.com/operation-details/${blog.slug}`;
    ...
    return {
        ...
        alternates: {
            ...
            languages: {
                ar: `https://www.almunifi.com/operation-details/${blog.slug_ar}`,
                en: `https://www.almunifi.com/operation-details/${blog.slug}`,
            }
        }
    }
}
