export const translations = {
    ...
    footer: {
        ar: {
            aboutText: "بخبرة الدكتور عبد الله المنيفي، استعد لتحقيق التحول الذي طالما حلمت به، اختر جراحة السمنة المثالية لك وابدأ رحلتك نحو حياة صحية وجسم مثالي.",
            ...
            operationList: [
                ...
                { name: "عملية استئصال المرارة", link: "/operation-details/استئصال-المرارة" },
                { name: "تحويل المسار المصغر", link: "/operation-details/تحويل-المسار-المصغر" },
                { name: "إصلاح الفتق بالمنظار", link: "/operation-details/إصلاح-الفتق-بالمنظار" },
                { name: "إصلاح الانفصال العضلي", link: "/operation-details/إصلاح-الانفصال-العضلي" },
                { name: "تحويل مسار المعدة الكلاسيكي", link: "/operation-details/تحويل-مسار-المعدة-الكلاسيكي" },
            ]
        },
        en: {
            aboutText: "With Dr. Abdullah Al-Munifi's experience, get ready to achieve the transformation you've always dreamed of. Choose the ideal bariatric surgery for you and start your journey towards a healthy life and an ideal body.",
    ...
    ticker: {
        ...
        en: ["Gastroesophageal Reflux", "Gallbladder Removal", "Hernia Surgeries", "Obesity"]
    },
    about: {
        ar: {
            title: "عن الدكتور",
            hero: {
                ...
                eduDesc: "حرصت خلال رحلتي المهنية على تطوير معرفتي واكتساب الخبرات الأكاديمية من أفضل الجامعات والمراكز العالمية، مما ساعدني على تقديم رعاية طبية متقدمة وتحقيق نتائج مميزة لمرضاي.",
                eduList: [
                    {
                    ...
                    {
                        title: "الزمالة الكندية في جراحة السمنة والمناظير المتقدمة والروبوت",
        ...
        en: {
            ...
            hero: {
                ...
                desc1: "Dr. Abdullah Al-Munaifi is considered one of the leading surgeons in the field of bariatric, advanced laparoscopic, and robotic surgery. Throughout his years of experience, he has combined precise scientific knowledge with extensive clinical practice to deliver advanced medical care based on the highest international standards. Dr. Abdullah is committed to ensuring that each patient’s health journey is clear and safe—from the initial evaluation, to selecting the most suitable procedure, and finally through continuous follow-up that guarantees the best long-term outcomes.",
                desc2: "With more than 14 years of experience, Dr. Abdullah has worked in several major referral hospitals inside and outside the Kingdom, gaining diverse professional exposure in specialized international centers. This has enabled him to treat thousands of cases in bariatric and gastrointestinal surgery. He consistently applies the latest surgical and non-surgical techniques, tailoring each approach to the patient’s individual needs, with the goal of improving quality of life and supporting a sustainable healthy lifestyle.",
                skillsTitle: "Skills",
                skillsSub: "Advanced Clinical Expertise in Bariatric and Laparoscopic Surgery",
                skillsDesc: "Throughout my years of work in bariatric and minimally invasive surgery, I have gained a wide range of surgical and non-surgical skills that I offer to my patients, always ensuring that I select the most suitable technique for each case to achieve the best possible outcomes.",
                skillsList: [
                    "Sleeve gastrectomy",
                ...
                eduDesc: "Throughout my medical career, I have been committed to developing my knowledge and gaining advanced academic experience from top universities and international medical centers. This has enabled me to provide highly specialized care and achieve outstanding results for my patients.",
                eduList: [
                    {
                    ...
                    {
                        title: "French Board in General Surgery and Gastrointestinal Surgery",
                        sub: "Côte d’Azur University, Nice, France (2018)"
                    },
                    {
                        title: "Canadian Fellowship in Bariatric Surgery, Advanced Laparoscopy, and Robotic Surgery",
